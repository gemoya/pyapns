...
def provision(app_id, path_to_cert, environment, timeout=15, asynchronous=False,
...
@default_callback
@reprovision_and_retry
def notify(app_id, tokens, notifications, asynchronous=False, callback=None,
           errback=None):
...
@default_callback
@reprovision_and_retry
def feedback(app_id, asynchronous=False, callback=None, errback=None):
    args = [app_id]
